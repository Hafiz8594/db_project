	...
	<fieldset>
		...
		<center>
			<table>
				...
				<tr>
					<td><button onClick = "location.href='loginPage.html'" style="width: 200px; height: 60px" type="button">My Shows</button></td>
					<td><button onClick = "location.href='signupPage.html'" style="width: 200px; height: 60px" type="button">My Albums</button></td>
				</tr>
				<tr>
